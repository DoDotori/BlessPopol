...
static public class NGUIText
{
	...
	static public bool WrapText (string text, out string finalText , UILabel label)
	{
        return WrapText(text, out finalText, false, label);
	}
    ...
    static public bool WrapText(string text, out string finalText, bool keepCharCount, UILabel label)
	{
